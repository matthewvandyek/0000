...
var $author$project$Form$init = A3($author$project$Form$Model, '', '', '');
...
var $author$project$Form$PasswordAgain = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Form$viewInput = F4(
...
var $author$project$Form$viewValidation = function (model) {
...
var $author$project$Form$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A4($author$project$Form$viewInput, 'text', 'Name', model.H, $author$project$Form$Name),
				A4($author$project$Form$viewInput, 'password', 'Password', model.E, $author$project$Form$Password),
				A4($author$project$Form$viewInput, 'password', 'Re-enter Password', model.F, $author$project$Form$PasswordAgain),
				$author$project$Form$viewValidation(model)
			]));
};
var $author$project$Form$main = $elm$browser$Browser$sandbox(
	{aw: $author$project$Form$init, aD: $author$project$Form$update, aE: $author$project$Form$view});
