...
var $author$project$MyFirstHttp$GotText = $elm$core$Basics$identity;
var $author$project$MyFirstHttp$Loading = {$: 1};
...
var $author$project$MyFirstHttp$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$MyFirstHttp$Loading,
		$elm$http$Http$get(
			{
...
var $author$project$MyFirstHttp$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$MyFirstHttp$Failure = {$: 0};
var $author$project$MyFirstHttp$Success = function (a) {
	return {$: 2, a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$MyFirstHttp$update = F2(
	function (msg, model) {
		var result = msg;
		if (!result.$) {
			var fullText = result.a;
			return _Utils_Tuple2(
				$author$project$MyFirstHttp$Success(fullText),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2($author$project$MyFirstHttp$Failure, $elm$core$Platform$Cmd$none);
		}
	});
var $elm$html$Html$pre = _VirtualDom_node('pre');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$MyFirstHttp$view = function (model) {
	switch (model.$) {
		case 0:
...
var $author$project$MyFirstHttp$main = $elm$browser$Browser$element(
	{aA: $author$project$MyFirstHttp$init, aL: $author$project$MyFirstHttp$subscriptions, aO: $author$project$MyFirstHttp$update, aQ: $author$project$MyFirstHttp$view});
_Platform_export({'MyFirstHttp':{'init':$author$project$MyFirstHttp$main(
