...
var $author$project$ReverseText$init = {z: ''};
...
var $author$project$ReverseText$update = F2(
	function (msg, model) {
		var newContent = msg;
...
var $author$project$ReverseText$Change = $elm$core$Basics$identity;
...
var $author$project$ReverseText$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$ReverseText$main = $elm$browser$Browser$sandbox(
	{au: $author$project$ReverseText$init, aC: $author$project$ReverseText$update, aD: $author$project$ReverseText$view});
_Platform_export({'ReverseText':{'init':$author$project$ReverseText$main(
